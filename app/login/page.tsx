    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
      ...
      <div className="flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-24 xl:px-32">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <p className="text-slate-600 mb-8">Enter your details to access your account.</p>
          ...
          <form className="space-y-5">
            ...
            <div>
              ...
              <input type="password" className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all" placeholder="••••••••" />
            </div>
            <Button className="w-full rounded-xl h-12 text-base mt-2">Sign In</Button>
          </form>
